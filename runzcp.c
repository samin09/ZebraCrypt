...
start:
    system("CLS");
    printf("\n\n\t\t\aCAUTION: Once you set a password,\n\t\tit can't be undone\n\t\t to open this application.\n");
    gotoxy(8,8);
    printf("\tLet's get started.\n\t\tYou need to specify  \n\t\ta password to open this application.");
   fflush(stdin);
...
int main()
{
    ...
    SMALL_RECT windowSize = {0, 0, 75, 30};
